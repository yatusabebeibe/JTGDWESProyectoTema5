...
<body>
    ...
    <main>
    <?php
        echo "<h1>Explotacion:</h1>";

        echo "<h2>Borrado:</h2>";
        highlight_file("../scriptDB/CreaDBJTGDWESProyectoTema5.sql");

        echo "<h2>Creacion:</h2>";
        highlight_file("../codigoPHP/CreaDBJTGDWESProyectoTema5.php");

        echo "<h2>Carga inicail:</h2>";
        highlight_file("../codigoPHP/CreaDBJTGDWESProyectoTema5.php");
    ?>
    </main>
